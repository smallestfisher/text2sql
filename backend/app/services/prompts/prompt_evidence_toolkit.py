...
class PromptEvidenceToolkit:
    """Mechanical prompt helpers: metadata access, evidence select/score/render.

    Business facts still come from semantic assets / retrieval; this class only
    loads, ranks by evidence signals, trims, and renders. Ranking heuristics that
    touch domain-ish tokens are inherited as-is (behavior-preserving); they are
    ...
    def __init__(
        ...
        *,
        ...
        sql_dialect=None,
        sql_ast_validator=None,
        example_factory=None,
    ) -> None:
        self.semantic_runtime = semantic_runtime
        self.metadata_registry = metadata_registry
        self.sql_dialect = sql_dialect
        self.sql_ast_validator = sql_ast_validator
